...
class _DetailPageState extends State<DetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    var weather = widget.consolidatedWeatherList[selectedIndex]['weather'][0]
            ['description']
        .toUpperCase();
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    var parsedDate = DateTime.parse(
                        widget.consolidatedWeatherList[index]['dt_txt']);
                    var newDate =
                        DateFormat('EEEE').format(parsedDate).substring(0, 3);
                    var newHour = widget.consolidatedWeatherList[index]
                            ['dt_txt']
                        .substring(11, 13);
                    return Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            widget.consolidatedWeatherList[index]['main']
                                        ['temp']
                                    .round()
                                    .toString() +
                                " ºC",
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  WeatherItem(
                                    ...
                                    humidity: widget.consolidatedWeatherList[
                                        selectedIndex]['main']['humidity'],
                                  ),
                                  WeatherItem(
                                    text: 'Cao nhất',
                                    value: 0,
                      ...
                      child: SizedBox(
                        ...
                        child: ListView.builder(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              ...
                              var currentDate =
                                  DateFormat('d/M - H').format(myDate);
                              return Container(
